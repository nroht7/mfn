object FrmAktorzy: TFrmAktorzy
  ...
  object ActionList1: TActionList
    ...
    object acLnkIdz: TAction
      Category = 'Linki'
      Caption = 'Otwórz'
      Hint = 'Otwórz link'
      ImageIndex = 37
      OnExecute = acLnkIdzExecute
    end
    object acLnkDodaj: TAction
      Category = 'Linki'
      Caption = 'Dodaj'
      Hint = 'Dodaje nowy link'
      ImageIndex = 35
      OnExecute = acLnkDodajExecute
    end
    object acLnkUsun: TAction
      Category = 'Linki'
      Caption = 'Usuń'
      Hint = 'Usuwa link'
      ImageIndex = 36
      OnExecute = acLnkUsunExecute
    end
    object acLnkDBEdytuj: TDataSetEdit
      Category = 'Linki'
      Caption = '&Edytuj'
      Hint = 'Edycja'
      ImageIndex = 3
    ...
    object acLnkDBZatw: TDataSetPost
      Category = 'Linki'
      Caption = 'Zatwie&rdź'
      Hint = 'Opublikuj'
      ImageIndex = 7
    ...
    object acLnkDBAnuluj: TDataSetCancel
      Category = 'Linki'
      Caption = '&Anuluj'
      Hint = 'Anuluj'
      ImageIndex = 0
